...
import { LazyValue } from 'ssephox/katamari/api/LazyValue';
import * as LazyValues from 'ssephox/katamari/api/LazyValues';
import { Optional } from 'ssephox/katamari/api/Optional';
import { tOptional } from 'ssephox/katamari/api/OptionalInstances';
