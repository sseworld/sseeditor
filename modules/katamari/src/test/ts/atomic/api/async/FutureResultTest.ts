...
import * as Fun from 'ssephox/katamari/api/Fun';
import { Future } from 'ssephox/katamari/api/Future';
import { FutureResult } from 'ssephox/katamari/api/FutureResult';
import { Result } from 'ssephox/katamari/api/Result';
import { tResult } from 'ssephox/katamari/api/ResultInstances';
import { arbResult } from 'ssephox/katamari/test/arb/ArbDataTypes';
import { eqAsync } from 'ssephox/katamari/test/AsyncProps';
