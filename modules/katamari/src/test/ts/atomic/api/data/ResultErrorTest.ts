...
import * as Results from 'ssephox/katamari/api/Results';
import { arbResultError, arbResultValue } from 'ssephox/katamari/test/arb/ArbDataTypes';
import { assertNone } from 'ssephox/katamari/test/AssertOptional';
import { assertResult } from 'ssephox/katamari/test/AssertResult';
