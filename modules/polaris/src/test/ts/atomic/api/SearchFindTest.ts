...
import * as Pattern from 'ssephox/polaris/api/Pattern';
import * as Search from 'ssephox/polaris/api/Search';
import * as Safe from 'ssephox/polaris/pattern/Safe';
import { PRegExp } from 'ssephox/polaris/pattern/Types';
