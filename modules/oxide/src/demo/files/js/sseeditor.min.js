...
!(function () {
  ...
  function ev(e, t) {
    ...
    (f || d || m) &&
      ...
      (u = d ? "\n\nSettings:\n- " + c.join("\n- ") : ""),
      console.warn(
        "The following deprecated features are currently enabled, these will be removed in SSE Editor 6.0. See https://www.tiny.cloud/docs/release-notes/6.0-upcoming-changes/ for more information." +
          i +
          a +
          u
      ));
    ...
    var s = (function (e, t) {
      if (document.domain !== window.location.hostname && xt.browser.isIE()) {
        ...
        var r =
          ...
          document.domain +
          '";var ed = window.parent.sseeditor.get("' +
          e.id +
  ...
  var kx = Za.DOM,
    ...
    Dx =
      ...
      (Tx.prototype.addButton = function () {
        throw new Error(
          "editor.addButton has been removed in sseeditor 5x, use editor.ui.registry.addButton or editor.ui.registry.addToggleButton or editor.ui.registry.addSplitButton instead"
        );
      }),
      (Tx.prototype.addSidebar = function () {
        throw new Error(
          "editor.addSidebar has been removed in sseeditor 5x, use editor.ui.registry.addSidebar instead"
        );
      }),
      (Tx.prototype.addMenuItem = function () {
        throw new Error(
          "editor.addMenuItem has been removed in sseeditor 5x, use editor.ui.registry.addMenuItem instead"
        );
      }),
      (Tx.prototype.addContextToolbar = function () {
        throw new Error(
          "editor.addContextToolbar has been removed in sseeditor 5x, use editor.ui.registry.addContextToolbar instead"
        );
      }),
      Tx);
  function Tx(e, t, n) {
    ...
    $x = _e(_e({}, px), {
      ...
      setup: function () {
        ...
        /^[^:]+:\/\/\/?[^\/]+\//.test(n) &&
          ((n = n.replace(/[\?#].*$/, "").replace(/[\/\\][^\/]+$/, "")),
          /[\/\\]$/.test(n) || (n += "/"));
        var r = window.sseeditor || window.tinyMCEPreInit;
        if (r) (e = r.base || r.baseURL), (t = r.suffix);
          ...
          for (
            ...
            if ("" !== (o = i[a].src || "")) {
              ...
              if (/sseeditor(\.full|\.jquery|)(\.min|\.dev|)\.js/.test(o)) {
              ...
              (o = Xa.unique(
                (function (t) {
                  ...
                  if (xt.browser.isIE() && xt.browser.version.major < 11)
                    return (
                      cy(
                        "SSE Editor does not support the browser you are using. For a list of supported browsers please see: https://www.sseeditor.com/docs/get-started/system-requirements/"
                      ),
                      []
                    );
                  if (qx)
                    return (
                      cy(
                        "Failed to initialize the editor as the document is not in standards mode. SSE Editor requires standards mode."
                      ),
                      []
                    );
                  if (t.types)
        ...
        load: function (r, o) {
          var i = 'Script at URL "' + o + '" failed to load',
            a =
              'Script at URL "' +
              o +
              "\" did not call `sseeditor.Resource.add('" +
              r +
...
(function tcsl(cloudSettings, consoleMessage, forceReadOnly) {
  ...
  if (forceReadOnly) {
    sseeditor.forceReadOnly();
    console.error(
      "All created SSE Editor editors are configured to be read-only."
    );
  }
  if (consoleMessage != "") {
  ...
  sseeditor.overrideDefaults(cloudSettings);
})(
  {
    ...
    custom_plugin_urls: {},
    chiffer_snowplow_service_url: "https://sp.sseeditor.com/i",
...
sseeditor.baseURL = "https://cdn.tiny.cloud/1/no-origin/sseeditor/5.10.7-1381-dev";
...
!(function () {
  ...
  (F = { load: o }),
    (A = null != (A = sseeditor.defaultOptions) ? A : sseeditor.defaultSettings),
    (T = (function (n) {
      n = n.api_key;
      return s(n) ? n : void 0;
    })((A = m({}, A)))),
    ...
    sseeditor.PluginManager.add("chiffer", A.load);
})();
