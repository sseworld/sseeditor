!(function (e, t) {
  ...
  function ve(e, t, r) {
    if ((void 0 === r && (r = null), !(this instanceof ve)))
      return new ve(e, t, r);
  ...
  function Se(e, t) {
    ...
    var r,
      ...
      o = e.first + e.size - 1;
    return t.line > o
      ? ve(o, ae(e, o).text.length)
      : ((n = ae(e, (r = t).line).text.length),
        null == (i = r.ch) || n < i
          ? ve(r.line, n)
          : i < 0
          ? ve(r.line, 0)
        ...
        if (e)
          for (var i = 0; i < e.length; ++i) {
            ...
            if (
              ...
              (n || (n = [])).push(
                new Me(l, s ? null : o.from - t, null == o.to ? null : o.to - t)
              );
            }
          }
        return n;
    ...
    if (a)
      for (var p = 0; p < a.length; ++p) {
        ...
        if ((null != g.to && (g.to += c), null == g.from))
          Ne(s, g.marker) || ((g.from = c), u && (s || (s = [])).push(g));
  ...
  function Ze(e, t, r) {
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      o.to == t && (o.from != o.to && "before" == r ? (n = i) : (qe = i)),
        o.from == t && (o.from != o.to && "before" != r ? (n = i) : (qe = i));
    }
    return null != n ? n : qe;
  }
  var Qe = (function () {
    ...
    return function (e, t) {
      ...
      return (
        "ltr" == t &&
          (1 == A[0].level &&
            (O = e.match(/^\s+/)) &&
            ((A[0].from = O[0].length), A.unshift(new K(0, 0, O[0].length))),
          1 == $(A).level &&
            (O = e.match(/\s+$/)) &&
            (($(A).to -= O[0].length), A.push(new K(0, i - O[0].length, i)))),
        "rtl" == t ? A.reverse() : A
      );
    };
  })();
  ...
  (Et.prototype.lookAhead = function (e) {
    ...
    (Et.fromSaved = function (e, t, r) {
      return t instanceof Pt
        ? new Et(e, Dt(e.mode, t.state), r, t.lookAhead)
        : new Et(e, Dt(e.mode, t), r);
    }),
  ...
  function Kt(e, t, r, n) {
    ...
    for (n && (o = []); (n || c.pos < t.ch) && !c.eol(); )
      (c.start = c.pos),
        (i = Ut(s, c, u.state)),
        n && o.push(new Vt(c, i, Dt(l.mode, u.state)));
      ...
      if (
        ((a =
          h.pos > e.options.maxHighlightLength
            ? ((s = !1), l && Bt(e, t, n, h.pos), (h.pos = t.length), null)
            : jt(Ut(r, h, n.state, f), o)),
        f)
      ) {
        var d = f[0].name;
        d && (a = "m-" + (a ? d + " " + a : d));
  ...
  function nr(e, t, r) {
    (this.line = t),
      ...
      (this.size = this.rest ? fe($(this.rest)) - r + 1 : 1),
  ...
  function Ar(e, t) {
    ...
    n && !n.text
      ? (n = null)
      : n && n.changes && (ur(e, n, r, tn(e)), (e.curOp.forceUpdate = !0)),
      n ||
        (n = (function (e, t) {
          var r = fe((t = Ue(t))),
                ...
                if (
                  (i =
                    x && C < 9 && 0 == s && a == o.coverEnd - o.coverStart
                      ...
                      : Pr(k(l, s, a).getClientRects(), n)).left ||
                  i.right ||
                  0 == s
                )
                  break;
  ...
  function _r(e, t, r) {
    ...
    var i = de(n, r),
      o = n.first + n.size - 1;
    if (o < i)
      return Yr(n.first + n.size - 1, ae(n, o).text.length, null, !0, 1);
    t < 0 && (t = 0);
    for (var l = ae(n, i); ; ) {
      var s = Qr(e, l, i, t, r),
          ...
          : function (n, i, o, l, s, a, u) {
              var e = le(
                  function (e) {
                    ...
                    return Zr(
                      jr(
                        n,
                        ve(o, r ? t.to : t.from, r ? "before" : "after"),
                        "line",
                        i,
                        l
                      ),
              ...
              if (0 < e) {
                var r = 1 != t.level,
                  c = jr(
                    n,
                    ve(o, r ? t.from : t.to, r ? "after" : "before"),
                    "line",
                    i,
                    l
                  );
  ...
  function Jr(e) {
    ...
    if (null == Wr) {
      Wr = A("pre");
      for (var t = 0; t < 49; ++t)
        Wr.appendChild(document.createTextNode("x")), Wr.appendChild(A("br"));
  ...
  function ln(e, t, r, n) {
    ...
    if (n && 1 == u.xRel && (a = ae(e.doc, u.line).text).length == u.ch) {
      ...
      u = ve(
        u.line,
        Math.max(0, Math.round((o - Sr(e.display).left) / en(e.display)) - c)
      );
    }
    return u;
  }
  ...
  function yn(e) {
    for (
      ...
      if (!i.hidden) {
        ...
        if (
          (l < 2 && (l = Jr(t)),
          (0.005 < c || c < -0.005) && (he(i.line, l), bn(i.line), i.rest))
        )
          for (var h = 0; h < i.rest.length; h++) bn(i.rest[h]);
    ...
    if (r && r.ensure) {
      ...
      s < o
        ...
        : Math.min(a, t.lastLine()) >= l &&
          ((o = de(t, Ye(ae(t, a)) - e.wrapper.clientHeight)), (l = a));
    }
  ...
  function On(e, t) {
    Math.abs(e.doc.scrollTop - t) < 2 ||
      (g || li(e, { top: t }), An(e, t, !0), g && li(e), ti(e, 100));
  }
  function An(e, t, r) {
    (t = Math.min(
  ...
  function zn(r) {
    r.display.scrollbars &&
      ...
      (r.display.scrollbars = new In[r.options.scrollbarStyle](
        function (e) {
  ...
  function Un(e) {
    ...
    !(r = (t = n).display).scrollbarsClipped &&
      ...
      (r.heightForcer.style.height = Lr(t) + "px"),
      (r.sizer.style.marginBottom = -r.nativeBarWidth + "px"),
      (r.sizer.style.borderRightWidth = Lr(t) + "px"),
    ...
    e.updatedDisplay && yn(t),
      ...
      r.maxLineChanged &&
        ...
        (e.maxScrollLeft = Math.max(
          0,
          r.sizer.offsetLeft + e.adjustWidthTo - kr(t)
        ))),
  ...
  function Kn(e) {
    ...
    null != e.adjustWidthTo &&
      ...
      e.maxScrollLeft < t.doc.scrollLeft &&
        Dn(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0),
  ...
  function jn(e) {
    ...
    null != e.scrollLeft && Dn(t, e.scrollLeft, !0, !0),
    e.scrollToPos) &&
      (function (e, t) {
        ...
        (function (e, t, r, n) {
          ...
          null == n && (n = 0),
            e.options.lineWrapping ||
              ...
              (r =
                "before" ==
                (t = t.ch
                  ? ve(t.line, "before" == t.sticky ? t.ch - 1 : t.ch, "after")
                  : t).sticky
          ...
          t,
          Se(n, e.scrollToPos.from),
          Se(n, e.scrollToPos.to),
    ...
    if (i)
      for (var l = 0; l < i.length; ++l) i[l].lines.length || it(i[l], "hide");
    if (o)
      for (var s = 0; s < o.length; ++s)
        o[s].lines.length && it(o[s], "unhide");
  ...
  function qn(e, t, r, n) {
    ...
    if (
      ...
      Te && Ve(e.doc, t) < i.viewTo && Qn(e);
    else if (r <= i.viewFrom)
      Te && Ke(e.doc, r + n) > i.viewFrom
        ? Qn(e)
      ...
      u.iter(
        ...
        function (e) {
          if (h.line >= a.display.viewFrom) {
            ...
            e.text.length <= a.options.maxHighlightLength && Bt(a, e.text, h),
  ...
  function ii(e, t) {
    ...
    (a = o),
      ...
      0 == (c = (s = e).display).view.length || a >= c.viewTo || u <= c.viewFrom
        ? ((c.view = ir(s, a, u)), (c.viewFrom = a))
        : (c.viewFrom > a
            ? (c.view = ir(s, a, c.viewFrom).concat(c.view))
            : c.viewFrom < a && (c.view = c.view.slice(sn(s, a))),
          (c.viewFrom = a),
          c.viewTo < u
            ? (c.view = c.view.concat(ir(s, c.viewTo, u)))
            : c.viewTo > u && (c.view = c.view.slice(0, sn(s, u)))),
      (c.viewTo = u),
      ...
      (function (r, e, t) {
        ...
        for (var a = n.view, u = n.viewFrom, c = 0; c < a.length; c++) {
          ...
          if (h.hidden);
            ...
            h.changes &&
              (-1 < B(h.changes, "gutter") && (f = !1), ur(r, h, u, t)),
              f &&
                (M(h.lineNumber),
                h.lineNumber.appendChild(
                  document.createTextNode(ge(r.options, u))
                )),
  ...
  function oi(e, t) {
    for (
      ...
      ((n && e.options.lineWrapping && t.oldDisplayWidth != kr(e)) ||
        (r &&
          null != r.top &&
          (r = { top: Math.min(e.doc.height + Cr(e.display) - Tr(e), r.top) }),
  ...
  function gi(e, t) {
    ...
    if ((n && s) || (i && a)) {
      ...
      if (n && !g && !v && null != fi)
        return (
          i && a && On(e, Math.max(0, l.scrollTop + i * fi)),
            ...
            setTimeout(function () {
              if (null != o.wheelStartX) {
                ...
                (o.wheelStartX = o.wheelStartY = null),
                  r && ((fi = (fi * hi + r) / (hi + 1)), ++hi);
              }
            }, 200))
          : ((o.wheelDX += n), (o.wheelDY += i)));
    }
  }
  x ? (fi = -0.53) : g ? (fi = 15) : l ? (fi = -0.7) : a && (fi = -1 / 3);
  var vi = function (e, t) {
  ...
  (vi.prototype.primary = function () {
    ...
    (vi.prototype.deepCopy = function () {
      for (var e = [], t = 0; t < this.ranges.length; t++)
        e[t] = new mi(be(this.ranges[t].anchor), be(this.ranges[t].head));
  ...
  function Si(e, t, r) {
    return e.line == t.line
      ? ve(r.line, e.ch - t.ch + r.ch)
      : ve(r.line + (e.line - t.line), e.ch);
  }
  function Li(e) {
  ...
  function Wi(e, t) {
    var r = { from: be(t.from), to: wi(t), text: ue(e, t.from, t.to) };
    return (
  ...
  function Fi(e, t, r, n) {
    ...
    if (
      ...
      (l = $(o.changes)),
        0 == me(t.from, t.to) && 0 == me(t.from, l.to)
          ? (l.to = wi(t))
          : o.changes.push(Wi(e, t));
    else {
      var u = $(i.done);
      for (
        (u && u.ranges) || Ei(e.sel, i.done),
  ...
  function Bi(e, t, r) {
    for (var n = [], i = 0; i < e.length; ++i) {
      var o = e[i];
      if (o.ranges) n.push(r ? vi.prototype.deepCopy.call(o) : o);
      else {
        var l = o.changes,
          s = [];
        n.push({ changes: s });
  ...
  function _i(e, t, r) {
    ...
    (st(e, "beforeSelectionChange") ||
      (e.cm && st(e.cm, "beforeSelectionChange"))) &&
      ((n = e),
      (o = r),
      (l = {
        ranges: (i = t).ranges,
      ...
      n.cm && it(n.cm, "beforeSelectionChange", n.cm, l),
      ...
      $i(
        ...
        Zi(
          ...
          t,
          (r && r.bias) ||
            (me(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1),
          !0
        )
      ),
      (r && !1 === r.scroll) || !e.cm || kn(e.cm);
  }
  function $i(e, t) {
    t.equals(e.sel) ||
      ((e.sel = t),
  ...
  function Zi(e, t, r, n) {
    for (var i, o = 0; o < t.ranges.length; o++) {
      ...
      (i || a != l.anchor || u != l.head) &&
        (i || (i = t.ranges.slice(0, o)), (i[o] = new mi(a, u)));
    }
        ...
        if (
          ...
          if (r) {
            ...
            if (
              ((n < 0 ? a.inclusiveRight : a.inclusiveLeft) &&
                (u = eo(e, u, -n, u && u.line == t.line ? o : null)),
              u &&
                u.line == t.line &&
                (c = me(u, r)) &&
                (n < 0 ? c < 0 : 0 < c))
          ...
          return (
            (n < 0 ? a.inclusiveLeft : a.inclusiveRight) &&
              (h = eo(e, h, n, h.line == t.line ? o : null)),
            h ? Qi(e, h, t, n, i) : null
          );
        }
      }
  ...
  function eo(e, t, r, n) {
    return r < 0 && 0 == t.ch
      ? t.line > e.first
        ? Se(e, ve(t.line - 1))
        : null
      : 0 < r && t.ch == (n || ae(e, t.line)).text.length
      ? t.line < e.first + e.size - 1
        ? ve(t.line + 1, 0)
        : null
      : new ve(t.line, t.ch + r);
  }
  function to(e) {
  ...
  function no(e, t, r) {
    ...
    if (
      !(st(e, "beforeChange") || (e.cm && st(e.cm, "beforeChange"))) ||
      (t = ro(e, t, !0))
    ) {
      var n =
        ke &&
  ...
  function io(e, r) {
    if (1 != r.text.length || "" != r.text[0] || 0 != me(r.from, r.to)) {
      ...
      var n = [];
      Ni(e, function (e, t) {
        t || -1 != B(n, e.history) || (ho(e.history, r), n.push(e.history)),
          so(e, r, null, Ae(e, r));
      });
    }
  }
    ...
    if (!t || e) {
      ...
      if (u != s.length) {
        for (r.lastOrigin = r.lastSelOrigin = null; ; ) {
          ...
          if ((Ei(l, a), e && !l.equals(i.sel)))
            return void Yi(i, l, { clearRedo: !1 });
          n = l;
        }
        var c = [];
        Ei(n, a),
        ...
        for (
          var h = st(i, "beforeChange") || (i.cm && st(i.cm, "beforeChange")),
            f = function (e) {
              var r = l.changes[e];
              if (((r.origin = o), h && !ro(i, r, !1)))
                return (s.length = 0), {};
              c.push(Wi(i, r));
              var t = e ? Ci(i, r) : $(s);
              so(i, r, t, Ri(i, r)),
              ...
              Ni(i, function (e, t) {
                t ||
                  -1 != B(n, e.history) ||
                  (ho(e.history, r), n.push(e.history)),
                  so(e, r, null, Ri(e, r));
              });
            },
      ...
      t.to.line > o &&
        ...
        e.cm
          ? (function (e, t, r) {
              ...
              t.full
                ? qn(e)
                : o.line != l.line || 1 != t.text.length || Ti(e.doc, t)
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      if (o.ranges) {
        ...
        for (var s = 0; s < o.ranges.length; s++)
          uo(o.ranges[s].anchor, t, r, n), uo(o.ranges[s].head, t, r, n);
      } else {
  ...
  function fo(e, t, r, n) {
    var i = t,
      o = t;
    return (
      "number" == typeof t ? (o = ae(e, Ce(e, t))) : (i = fe(t)),
  ...
  function wo(t, n, i, e, r) {
    ...
    if (
      ...
      if (
        Ge(t, n.line, n, i, o) ||
        (n.line != i.line && Ge(t, i.line, n, i, o))
      )
        throw new Error(
    ...
    if (
      (t.iter(a, i.line + 1, function (e) {
        ...
        u &&
          ...
          Ue(e) == u.display.maxLine &&
          (s = !0),
          o.collapsed && a != n.line && he(e, 0),
          (t = e),
      ...
      if ((s && (u.curOp.updateMaxLine = !0), o.collapsed))
        ...
        for (var c = n.line; c <= i.line; c++) Zn(u, c, "text");
  ...
  (bo.prototype.clear = function () {
    ...
    if (!this.explicitlyCleared) {
      ...
      for (var i = null, o = null, l = 0; l < this.lines.length; ++l) {
        ...
        t && !e.collapsed
          ? Zn(t, fe(s), "text")
          : t && (null != a.to && (o = fe(s)), null != a.from && (i = fe(s))),
      ...
      null != i && t && this.collapsed && qn(t, i, o + 1),
        (this.lines.length = 0),
        (this.explicitlyCleared = !0),
        this.atomic &&
          this.doc.cantEdit &&
          ((this.doc.cantEdit = !1), t && qi(t.doc)),
        t && sr(t, "markerCleared", t, this, i, o),
        r && Gn(t),
    ...
    (bo.prototype.changed = function () {
      ...
      l &&
        ...
        Xn(a, function () {
          ...
          if (
            (r &&
              (Er(r), (a.curOp.selectionChanged = a.curOp.forceUpdate = !0)),
            (a.curOp.updateMaxLine = !0),
            !je(s.doc, e) && null != s.height)
          ) {
            var n = s.height;
            s.height = null;
            var i = br(s) - n;
  ...
  (ko.prototype = Q(go.prototype, {
    ...
    setHistory: function (e) {
      ...
      (t.done = Bi(e.done.slice(0), null, !0)),
        (t.undone = Bi(e.undone.slice(0), null, !0));
    },
    ...
    addLineWidget: $n(function (e, t, r) {
      return (
        ...
        l && sr(l, "lineWidgetAdded", l, o, "number" == typeof i ? i : fe(i)),
        o
      );
      var n, i, o, l;
    }),
            ...
            var l = t.length,
              ...
              r = function (e, r) {
                if (
                  ...
                  -1 != B(i.options.allowDropFileTypes, e.type)
                ) {
      ...
      return jo(r, function (e) {
        if (e.empty()) {
          ...
          return e.head.ch == t && e.head.line < r.lastLine()
            ? { from: e.head, to: ve(e.head.line + 1, 0) }
            : { from: e.head, to: ve(e.head.line, t) };
        }
      ...
      return Xn(l, function () {
        for (var e = l.listSelections(), t = [], r = 0; r < e.length; r++)
          if (e[r].empty()) {
            ...
            if (i)
              if (
                (n.ch == i.length && (n = new ve(n.line, n.ch - 1)), 0 < n.ch)
              )
  ...
  function tl(e, t, r, n) {
    var i = (function (e, t, r) {
      ...
      return (
        (e.options.extraKeys && Bo(t, e.options.extraKeys, r, e)) ||
        Bo(t, e.options.keyMap, r, e)
      );
    })(e, t, n);
    return (
      "multi" == i && (e.state.keySeq = t),
      "handled" == i && sr(e, "keyHandled", e, t, r),
      ("handled" != i && "multi" != i) || (ut(r), dn(e)),
      !!i
    );
  }
  function rl(t, e) {
          ...
          a = l
            ? ((n = l),
              ...
              al && al.compare(o, n, i)
                ? ((sl = al = null), "triple")
                : sl && sl.compare(o, n, i)
                ? ((al = new ul(o, n, i)), (sl = null), "double")
                : ((sl = new ul(o, n, i)), (al = null), "single"))
            : "single";
        window.focus(),
            ...
            (1 == s
              ? l
                ? (function (e, t, r, n) {
                    ...
                    "single" == r &&
                    -1 < (i = l.contains(t)) &&
                    (me((i = l.ranges[i]).from(), t) < 0 || 0 < t.xRel) &&
                    (0 < me(i.to(), t) || t.xRel < 0)
                      ? (function (t, r, n, i) {
                          var o = t.display,
                            l = !1,
                            s = Yn(t, function (e) {
                            ...
                            if (0 != me(S, e))
                              if (((S = e), "rectangle" == y.unit)) {
                                for (
                                  var t = [],
                                    r = v.options.tabSize,
                                    n = z(ae(b, m.line).text, m.ch, r),
                                    i = z(ae(b, e.line).text, e.ch, r),
                                    o = Math.min(n, i),
                                    l = Math.max(n, i),
                                  ...
                                  o == l
                                    ...
                                    : u.length > c &&
                                      t.push(
                                        new mi(ve(s, c), ve(s, X(u, l, r)))
                                      );
                                }
                                t.length || t.push(new mi(m, m)),
                                  Yi(
                                    b,
                                    yi(v, C.ranges.slice(0, x).concat(t), x),
                                ...
                                p =
                                  0 < me(d.anchor, p)
                                    ? ((h = d.head), xe(f.from(), d.anchor))
                                    : ((h = d.anchor), we(f.to(), d.head));
                                var g = C.ranges.slice(0);
                                (g[x] = (function (e, t) {
                                  var r = t.anchor,
                                    n = t.head,
                                    i = ae(e.doc, r.line);
                                  if (0 == me(r, n) && r.sticky == n.sticky)
                                    return t;
                                  var o = Je(i);
                                  if (!o) return t;
                ...
                : dt(e) == r.scroller && ut(e)
              : 2 == s
              ? (l && Ui(t.doc, l),
                setTimeout(function () {
                  return r.input.focus();
                }, 20))
              : 3 == s && (S ? t.display.input.onContextMenu(e) : gn(t)));
      }
  }
  function hl(e, t, r) {
  ...
  function fl(e, t, r, n) {
    ...
    for (var a = 0; a < e.options.gutters.length; ++a) {
      ...
      if (u && u.getBoundingClientRect().right >= i)
        return it(e, r, e, de(e.doc, o), e.options.gutters[a], t), ht(t);
    }
  }
  function dl(e, t) {
  ...
  function pl(e, t) {
    ...
    wr(e.display, t) ||
      ((n = t),
      st((r = e), "gutterContextMenu") && fl(r, n, "gutterContextMenu", !1)) ||
      ot(e, t, "contextmenu") ||
      S ||
  ...
  function xl(e) {
    e.options.lineWrapping
      ...
      : (T(e.display.wrapper, "CodeMirror-wrap"), $e(e)),
      on(e),
      qn(e),
      zr(e),
      setTimeout(function () {
  ...
  function Cl(e, t) {
    ...
    for (var l in (ui((o.wrapper.CodeMirror = this)),
    gl(this),
          ...
          if (
            ...
            (r =
              !t.prev || s(t, t.prev)
                ...
                ? i.findWordAt(n)
                : new mi(ve(n.line, 0), Se(i.doc, ve(n.line + 1, 0)))),
    ...
    (t.autofocus && !f) || this.hasFocus()
      ...
      : mn(this),
    yl))
      yl.hasOwnProperty(l) && yl[l](r, t[l], vl);
  ...
  function Ll(e, t, r, n) {
    var i,
      o = e.doc;
    null == r && (r = "add"),
      "smart" == r && (o.mode.indent ? (i = Rt(e, t).state) : (r = "prev"));
    ...
    if ((f < u && (h += _(u - f)), h != c))
      return (
        ao(o, h, ve(t, 0), ve(t, c.length), "+input"), !(s.stateAfter = null)
      );
  ...
  function Ml(e, t, r, n, i) {
    ...
    if (l && 1 < n.ranges.length)
      if (kl && kl.text.join("\n") == t) {
        if (n.ranges.length % kl.text.length == 0) {
          a = [];
          for (var u = 0; u < kl.text.length; u++)
            a.push(o.splitLines(kl.text[u]));
        }
      } else
    ...
    for (var c = e.curOp.updateInput, h = n.ranges.length - 1; 0 <= h; h--) {
      var f = n.ranges[h],
        d = f.from(),
        p = f.to();
      f.empty() &&
        (r && 0 < r
          ...
          ? (p = ve(
              p.line,
              Math.min(ae(o, p.line).text.length, p.ch + $(s).length)
            ))
          : l &&
            kl &&
            kl.lineWise &&
    ...
    function a(e) {
      ...
      if (
          ...
          ? (function (t, r, s, e) {
              ...
              var p = function (e, t, r) {
                  for (
                    var n = function (e, t) {
                      return t
                        ? new ve(s.line, u(e, 1), "before")
                        : new ve(s.line, e, "after");
                    };
                    0 <= e && e < a.length;
                    e += t
                  ) {
        ...
        if (
          ...
          (r = i.line + o) < n.first ||
          r >= n.first + n.size ||
          ((i = new ve(r, i.ch, i.sticky)), !(s = ae(n, r)))
        )
          return !1;
  ...
  function Fl(e, t, r, n) {
    ...
    if ("page" == n) {
      var a = Math.min(
        ...
        u = Math.max(a - 0.5 * Jr(e.display), 3);
  ...
  function zl(e, t, r) {
    ...
    if (t == e.display.lineDiv) {
      if (!(n = e.display.lineDiv.childNodes[r]))
        return Il(e.clipPos(ve(e.display.viewTo - 1)), !0);
      (t = null), (r = 0);
    } else
  ...
  (Pl.prototype.init = function (e) {
    ...
    function r(e) {
      if (!ot(s, e)) {
        if (s.somethingSelected())
          Tl({ lineWise: !1, text: s.getSelections() }),
    ...
    (Pl.prototype.pollContent = function () {
      ...
      if (
        ...
        s.ch == ae(n.doc, s.line).text.length &&
          s.line < n.lastLine() &&
          (s = ve(s.line + 1, 0)),
      ...
      r =
        l.line == i.viewFrom || 0 == (e = sn(n, l.line))
          ? ((t = fe(i.view[0].line)), i.view[0].node)
          : ((t = fe(i.view[e].line)), i.view[e - 1].node.nextSibling);
      var a,
        u,
        c = sn(n, s.line);
      if (
      ...
      for (
        var h = n.doc.splitLines(
          ...
          f = ue(n.doc, ve(t, 0), ve(a, ae(n.doc, a).text.length));
      ...
      return 1 < h.length || h[0] || me(x, C)
        ? (ao(n.doc, h, x, C, "+input"), !0)
        : void 0;
    }),
  ...
  (Vl.prototype.init = function (t) {
    ...
    t.wrapper.insertBefore(this.wrapper, t.wrapper.firstChild),
      ...
      tt(i, "paste", function (e) {
        ot(n, e) || Nl(e, n) || ((n.state.pasteIncoming = !0), r.fastPoll());
      }),
      tt(i, "cut", o),
      tt(i, "copy", o),
    ...
    (function (i) {
      ...
      (i.defineOption = e),
        ...
        e("cursorHeight", 1, an, !0),
        e("singleCursorHeightPerLine", !0, an, !0),
        e("workTime", 100),
        e("workDelay", 100),
        e("flattenSpans", !0, ki, !0),
        e("addModeClass", !1, ki, !0),
        e("pollInterval", 100),
    ...
    (Bl.prototype = {
      ...
      setOption: function (e, t) {
        ...
        (r[e] == t && "mode" != e) ||
          ((r[e] = t),
          Gl.hasOwnProperty(e) && Yn(this, Gl[e])(this, t, n),
      ...
      removeOverlay: _n(function (e) {
        for (var t = this.state.overlays, r = 0; r < t.length; ++r) {
          ...
          if (n == e || ("string" == typeof e && n.name == e))
            return t.splice(r, 1), this.state.modeGen++, void qn(this);
        }
      }),
      ...
      indentSelection: _n(function (e) {
        for (
          ...
          if (o.empty())
            o.head.line > n &&
              (Ll(t, o.head.line, e, !0),
              (n = o.head.line),
              i == t.doc.sel.primIndex && kn(t));
          else {
            var l = o.from(),
              s = o.to(),
              a = Math.max(n, l.line);
      ...
      getStateAfter: function (e, t) {
        ...
        return Rt(
          this,
          (e = Ce(r, null == e ? r.first + r.size - 1 : e)) + 1,
          t
        ).state;
      },
      ...
      heightAtLine: function (e, t, r) {
        ...
        return (
          Ur(this, n, { top: 0, left: 0 }, t || "page", r || i).top +
          (i ? this.doc.height - Ye(n) : 0)
        );
      },
      ...
      addWidget: function (e, t, r, n, i) {
        ...
        (t.style.top = u + "px"),
          ...
          r &&
            ...
            null != (s = Sn(o, l)).scrollTop && On(o, s.scrollTop),
      ...
      moveH: _n(function (t, r) {
        ...
        this.extendSelectionsBy(function (e) {
          return n.display.shift || n.doc.extend || e.empty()
            ? Hl(n.doc, e.head, t, r, n.options.rtlMoveVisually)
            : t < 0
            ? e.from()
            : e.to();
        }, j);
      ...
      scrollIntoView: _n(function (e, t) {
        ...
        null == e
          ...
          (e.margin = t || 0),
          null != e.from.line
            ? ((n = e), Mn((r = this)), (r.curOp.scrollToPos = n))
  ...
  for (var Xl in ko.prototype)
    ko.prototype.hasOwnProperty(Xl) &&
      B(jl, Xl) < 0 &&
  ...
  return (
    ...
    (Kl.isModifierKey = Go),
    (Kl.lookupKey = Bo),
    (Kl.normalizeKeyMap = Ro),
    (Kl.StringStream = Ft),
    (Kl.SharedTextMarker = xo),
    (Kl.TextMarker = bo),
    (Kl.LineWidget = vo),
    (Kl.e_preventDefault = ut),
    (Kl.e_stopPropagation = ct),
    (Kl.e_stop = ft),
    (Kl.addClass = H),
    (Kl.contains = D),
    (Kl.rmClass = T),
