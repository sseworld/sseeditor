!(function (e) {
  ...
  Le.defineMode("javascript", function (e, l) {
        ...
        return (
          (t.tokenize =
            ...
            function (e, t) {
              var r,
                n = !1;
              if (o && "@" == e.peek() && e.match(v))
                return (t.tokenize = y), k("jsonld-keyword", "meta");
    ...
    function $() {
      (M.state.context = new I(M.state.context, M.state.localVars, !1)),
        (M.state.localVars = t);
    }
    function C() {
      (M.state.context = new I(M.state.context, M.state.localVars, !0)),
    ...
    function N(e, t) {
      return "var" == e
        ...
        ? ("else" == M.state.lexical.info &&
            M.state.cc[M.state.cc.length - 1] == P &&
            M.state.cc.pop()(),
          A(O("form"), W, N, P, je))
        : "function" == e
        ? A(Ie)
        ...
        ? ((M.marked = "keyword"), A(O("form"), Ce, P))
        : "variable" == e
        ? s && "declare" == t
          ? ((M.marked = "keyword"), A(N))
          : s &&
          ...
          ? ((M.marked = "keyword"),
            "enum" == t
              ? A(Ge)
              : "type" == t
              ? A(se, S("operator"), se, S(";"))
              : A(O("form"), we, S("{"), O("}"), ie, P, P))
          : s && "namespace" == t
          ? ((M.marked = "keyword"), A(O("form"), B, ie, P))
          : s && "abstract" == t
          ? ((M.marked = "keyword"), A(N))
          : A(O("stat"), Z)
        : "switch" == e
        ? A(O("form"), W, S("{"), O("}", "switch"), C, ie, P, P, q)
        : "case" == e
        ? A(B, S(":"))
        : "default" == e
        ? A(S(":"))
    ...
    function L(e) {
      if ("}" == e)
        return (M.marked = "string-2"), (M.state.tokenize = b), A(K);
    }
    function Q(e) {
    ...
    function ee(e, t) {
      ...
      if ("variable" == e || "keyword" == M.style) {
        ...
        if ("number" == e || "string" == e)
          return (M.marked = o ? "property" : M.style + " property"), A(re);
    ...
    function ce(e) {
      if (s && ":" == e)
        return M.stream.match(/^\s*\w+\s+is\b/, !1) ? A(B, ue, se) : A(se);
    }
    function ue(e, t) {
    ...
    function se(e, t) {
      return "keyof" == t || "typeof" == t
        ? ((M.marked = "keyword"), A("keyof" == t ? se : H))
        : "variable" == e || "void" == t
        ? ((M.marked = "type"), A(pe))
    ...
    function qe(e, t) {
      return "<" == t
        ? A(O(">"), ne(ve, ">"), P, qe)
        : "extends" == t || "implements" == t || (s && "," == e)
        ? ("implements" == t && (M.marked = "keyword"), A(s ? se : B, qe))
        : "{" == e
        ? A(O("}"), Oe, P)
        : void 0;
    }
    function Oe(e, t) {
      return "async" == e ||
        ("variable" == e &&
          ("static" == t || "get" == t || "set" == t || (s && z(t))) &&
          M.stream.match(/^\s+[\w$\xa1-\uffff]/, !1))
        ? ((M.marked = "keyword"), A(Oe))
        : "variable" == e || "keyword" == M.style
        ? ((M.marked = "property"), A(s ? Pe : Ie, Oe))
        : "[" == e
        ? A(B, oe, S("]"), s ? Pe : Ie, Oe)
        : "*" == t
        ? ((M.marked = "keyword"), A(Oe))
    ...
    function Se(e, t) {
      return "*" == t
        ? ((M.marked = "keyword"), A(De, S(";")))
        : "default" == t
        ? ((M.marked = "keyword"), A(B, S(";")))
        : "{" == e
        ? A(ne(Ne, "}"), De, S(";"))
        : V(N);
    }
    ...
    function Be(e, t) {
      return "{" == e
        ? ae(Be, "}")
        : ("variable" == e && r(t), "*" == t && (M.marked = "keyword"), A(We));
    }
    function He(e) {
      if ("," == e) return A(Be, He);
    }
    ...
    Le.registerHelper("wordChars", "javascript", /[\w$]/),
    Le.defineMIME("text/javascript", "javascript"),
    Le.defineMIME("text/ecmascript", "javascript"),
    Le.defineMIME("application/javascript", "javascript"),
    Le.defineMIME("application/x-javascript", "javascript"),
    Le.defineMIME("application/ecmascript", "javascript"),
    Le.defineMIME("application/json", { name: "javascript", json: !0 }),
    Le.defineMIME("application/x-json", { name: "javascript", json: !0 }),
    Le.defineMIME("application/ld+json", { name: "javascript", jsonld: !0 }),
    Le.defineMIME("text/typescript", { name: "javascript", typescript: !0 }),
    Le.defineMIME("application/typescript", {
      name: "javascript",
      typescript: !0,
    });
});
