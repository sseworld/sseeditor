!(function (e) {
  ...
  T.defineMode("css", function (e, t) {
    ...
    var o,
      ...
      m = t.fontProperties || {},
      h = t.counterDescriptors || {},
      g = t.colorKeywords || {},
      b = t.valueKeywords || {},
      f = t.allowNested,
      y = t.lineComment,
      w = !0 === t.supportsAtComponent;
    function k(e, t) {
      return (o = t), e;
    }
    function v(i) {
    ...
    var B = {
      top: function (e, t, r) {
        ...
        if (w && /@component/i.test(e)) return j(r, t, "atComponentBlock");
          ...
          function (e, t) {
            ...
            return "@" == r
              ...
              ? /[,+>*\/]/.test(r)
                ...
                ? (e.backUp(1), (t.tokenize = x), k("property", "word"))
                : /[\w\\\-]/.test(r)
  ...
  var t = ["domain", "regexp", "url", "url-prefix"],
    ...
    y = e(f),
    w = t.concat(o).concat(a).concat(l).concat(c).concat(p).concat(g).concat(f);
  function k(e, t) {
    for (var r, o = !1; null != (r = e.next()); ) {
      if (o && "/" == r) {
        t.tokenize = null;
  ...
  T.registerHelper("hintWords", "css", w),
