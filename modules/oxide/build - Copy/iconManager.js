...
sseeditor.IconManager = (function() {
  var iconPacks = {};
...
(function() {
  document.addEventListener('DOMContentLoaded', function () {
    var iconKeys = Object.keys(sseeditor.IconManager.list());
    if (iconKeys.length > 1) {
      ...
      select.value = sseeditor.IconManager.getActiveIconPack();
      select.addEventListener('change', function (e) {
        sseeditor.IconManager.setActiveIconPack(e.target.value);
      });
