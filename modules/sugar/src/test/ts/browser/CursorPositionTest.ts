...
import * as Awareness from 'ssephox/sugar/api/selection/Awareness';
import * as CursorPosition from 'ssephox/sugar/api/selection/CursorPosition';
import * as Edge from 'ssephox/sugar/api/selection/Edge';
