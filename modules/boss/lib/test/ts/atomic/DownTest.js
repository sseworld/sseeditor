...
UnitTest.test('DownTest', () => {
    ...
    const checkSelector = (expected, query) => {
        const actual = Down.selector(family, query);
        check(expected, actual);
    };
    const checkPredicate = (expected, id, predicate) => {
