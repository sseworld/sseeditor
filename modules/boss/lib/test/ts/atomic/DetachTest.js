...
UnitTest.test('DetachTest', () => {
    const check = (expectedRemain, expectedDetach, input, id) => {
    ...
    check('A(B)', Optional.some('C(D(E),F)'), Gene('A', '.', [
        Gene('B', '.', []),
        Gene('C', '.', [
            Gene('D', '.', [
                Gene('E', '.', [])
    ...
    check('A(B,C(D(E)))', Optional.some('F'), Gene('A', '.', [
        Gene('B', '.', []),
        Gene('C', '.', [
            Gene('D', '.', [
                Gene('E', '.', [])
    ...
    check('A(B,C(F))', Optional.some('D(E)'), Gene('A', '.', [
        Gene('B', '.'),
        Gene('C', '.', [
            Gene('D', '.', [
                Gene('E', '.')
    ...
    check('A(B,C(D(E),F))', Optional.none(), Gene('A', '.', [
        Gene('B', '.'),
        Gene('C', '.', [
            Gene('D', '.', [
                Gene('E', '.')
