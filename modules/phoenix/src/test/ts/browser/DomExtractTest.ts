...
import { Compare, SugarElement, SugarText } from '@ssephox/sugar';

import * as DomExtract from 'ssephox/phoenix/api/dom/DomExtract';
import { Page } from 'ssephox/phoenix/test/Page';
