...
describe('browser.sseeditor.core.EditorManagerTest', () => {
  ...
  it('get', (done) => {
    viewBlock.update('<textarea class="sseeditor"></textarea>');
    EditorManager.init({
      selector: 'textarea.sseeditor',
    ...
    EditorManager.init({
      ...
      init_instance_callback: (editor1) => {
        setTimeout(() => {
          ...
          EditorManager.init({
            selector: 'textarea',
            skin_url: '/project/sseeditor/js/sseeditor/skins/ui/oxide',
            content_css: '/project/sseeditor/js/sseeditor/skins/content/default',
