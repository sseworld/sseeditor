...
import { BeforeGetContentEvent, BeforeSetContentEvent, GetContentEvent, SetContentEvent } from 'sseeditor/core/api/EventTypes';
...
describe('browser.sseeditor.core.content.EditorContentTest', () => {
