...
import DomParser from 'sseeditor/core/api/html/DomParser';
import AstNode from 'sseeditor/core/api/html/Node';
import Schema from 'sseeditor/core/api/html/Schema';
import * as InsertList from 'sseeditor/core/content/InsertList';

describe('browser.sseeditor.core.content.insert.InsertListTest', () => {
  const schema = Schema({});
