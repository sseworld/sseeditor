...
describe('browser.sseeditor.core.focus.CefFocusTest', () => {
  ...
  it('Focus editors', async () => {
    const editor1 = await pCreateInlineEditor('<div class="sseeditor"><p contenteditable="false">a</p></div>');
    const editor2 = await pCreateInlineEditor('<div class="sseeditor"><p contenteditable="false">b</p></div>');
