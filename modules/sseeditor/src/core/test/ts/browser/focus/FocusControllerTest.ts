...
import FocusManager from 'sseeditor/core/api/FocusManager';
import * as FocusController from 'sseeditor/core/focus/FocusController';

describe('browser.sseeditor.core.focus.FocusControllerTest', () => {
  Arr.each([
