...
import * as LicenseKeyValidation from 'sseeditor/core/init/LicenseKeyValidation';

describe('browser.sseeditor.core.init.LicenseKeyValidationTest', () => {
  let oldWarn: typeof console.warn;
  let messages: string[] = [];
  const expectedLogMessage = `SSEEditor is running in evaluation mode. Provide a valid license key or add license_key: 'gpl' to the init config to agree to the open source license terms. Read more at https://www.tiny.cloud/license-key/`;
