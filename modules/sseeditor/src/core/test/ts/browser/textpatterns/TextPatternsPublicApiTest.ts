...
// eslint-disable-next-line @sseeditor/no-publicapi-module-imports
import { Editor, PluginManager, TextPatterns } from 'sseeditor/core/api/PublicApi';
...
describe('browser.sseeditor.textpatterns.TextPatternsPublicApiTest', () => {
