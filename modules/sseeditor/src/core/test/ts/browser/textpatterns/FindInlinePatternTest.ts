...
import * as InlinePattern from 'sseeditor/core/textpatterns/core/InlinePattern';
import {
  DynamicPatternContext, InlinePattern as InlinePatternType, InlinePatternMatch, PatternSet
} from 'sseeditor/core/textpatterns/core/PatternTypes';
import { PathRange } from 'sseeditor/core/textpatterns/utils/PathRange';
import { getBeforeText, getParentBlock, resolveFromDynamicPatterns } from 'sseeditor/core/textpatterns/utils/Utils';
import ListsPlugin from 'sseeditor/plugins/lists/Plugin';

import { getPatternSetFor } from '../../module/test/TextPatternsUtils';

describe('browser.sseeditor.textpatterns.FindInlinePatternTest', () => {
