...
import * as BlockPattern from 'sseeditor/core/textpatterns/core/BlockPattern';
import { DynamicPatternContext, PatternSet } from 'sseeditor/core/textpatterns/core/PatternTypes';
import { getParentBlock, resolveFromDynamicPatterns } from 'sseeditor/core/textpatterns/utils/Utils';

import { getPatternSetFor } from '../../module/test/TextPatternsUtils';

// Similar to modules/sseeditor/src/core/test/ts/atomic/textpatterns/FindBlockPatternsTest.ts
// but uses DOM and includes tests for text_patterns_lookup
describe('browser.sseeditor.textpatterns.FindBlockPatternsTest', () => {
