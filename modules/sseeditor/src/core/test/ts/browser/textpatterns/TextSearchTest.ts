...
import { SpotPoint } from 'sseeditor/core/alien/Spot';
import * as TextSearch from 'sseeditor/core/alien/TextSearch';
import Editor from 'sseeditor/core/api/Editor';

describe('browser.sseeditor.core.textpatterns.TextSearchTest', () => {
