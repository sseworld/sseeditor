...
import { FakeCaretPosition, closestCaretCandidateNodeRect, closestFakeCaretCandidate } from 'sseeditor/core/caret/ClosestCaretCandidate';
...
describe('browser.sseeditor.core.ClosestCaretCandidateTest', () => {
