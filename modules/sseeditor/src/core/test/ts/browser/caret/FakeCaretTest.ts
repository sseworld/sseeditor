...
import { FakeCaret, isFakeCaretTarget } from 'sseeditor/core/caret/FakeCaret';
import { isFakeCaretTableBrowser } from 'sseeditor/core/keyboard/TableNavigation';
import * as Zwsp from 'sseeditor/core/text/Zwsp';

import * as CaretAsserts from '../../module/test/CaretAsserts';
import * as ViewBlock from '../../module/test/ViewBlock';

describe('browser.sseeditor.core.caret.FakeCaretTest', () => {
