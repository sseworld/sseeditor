...
import { BeforeGetContentEvent } from 'sseeditor/core/api/EventTypes';
import { EditorEvent } from 'sseeditor/core/api/util/EventDispatcher';
import { GetSelectionContentArgs } from 'sseeditor/core/content/ContentTypes';
import { getContent } from 'sseeditor/core/selection/GetSelectionContent';

describe('browser.sseeditor.selection.GetSelectionContentTest', () => {
