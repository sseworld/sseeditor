...
import { SetContentEvent } from 'sseeditor/core/api/EventTypes';
import { EditorEvent } from 'sseeditor/core/api/util/EventDispatcher';
import { SetSelectionContentArgs } from 'sseeditor/core/content/ContentTypes';
import * as SetSelectionContent from 'sseeditor/core/selection/SetSelectionContent';

describe('browser.sseeditor.selection.SetSelectionContentTest', () => {
