...
} from 'sseeditor/core/bookmark/BookmarkTypes';
import * as GetBookmark from 'sseeditor/core/bookmark/GetBookmark';
import * as ResolveBookmark from 'sseeditor/core/bookmark/ResolveBookmark';

describe('browser.sseeditor.core.bookmark.BookmarksTest', () => {
