...
import Theme from 'sseeditor/themes/silver/Theme';

import * as ViewBlock from '../module/test/ViewBlock';

describe('browser.sseeditor.core.EditorManagerCommandsTest', () => {
  ...
  Arr.each([
    ...
    it(`mceToggleEditor (${test.label})`, (done) => {
      viewBlock.update('<textarea id="ed_1" class="sseeditor"></textarea>');
      EditorManager.init({
  ...
  it('mceAddEditor', (done) => {
    viewBlock.update('<textarea id="ed_1" class="sseeditor"></textarea><textarea id="ed_2" class="sseeditor"></textarea>');
    EditorManager.init({
