...
import URI from 'sseeditor/core/api/util/URI';

describe('browser.sseeditor.core.util.UriTest', () => {
  /* eslint max-len: 0 */
  ...
  it('relativeURLs', () => {
    ...
    assert.equal(new URI('http://www.site.com/dir1/dir2/').toRelative('@@sseeditor'), '@@sseeditor'); // Zope 3 URL
    assert.equal(new URI('http://www.site.com/dir1/dir2/').toRelative('../@@sseeditor'), '../@@sseeditor'); // Zope 3 URL
  ...
  it('absoluteURLs', () => {
    ...
    assert.equal(new URI('http://www.site.com/dir1/dir2/').toAbsolute('../@@sseeditor'), 'http://www.site.com/dir1/@@sseeditor'); // Zope 3 URL
