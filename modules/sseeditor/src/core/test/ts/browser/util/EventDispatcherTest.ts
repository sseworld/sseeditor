...
import EventDispatcher, { EditorEvent } from 'sseeditor/core/api/util/EventDispatcher';

describe('browser.sseeditor.core.util.EventDispatcherTest', () => {
  ...
  it('toggleEvent setting', () => {
    ...
    // eslint-disable-next-line @sseeditor/prefer-fun
    const listenerA = () => {};
    // eslint-disable-next-line @sseeditor/prefer-fun
    const listenerB = () => {};
