...
import * as CaretContainer from 'sseeditor/core/caret/CaretContainer';
import * as NodeType from 'sseeditor/core/dom/NodeType';

describe('browser.sseeditor.core.keyboard.MediaNavigationTest', () => {
  ...
  Arr.each([
    ...
    { type: 'embed', content: '<embed src="custom/sseeditor/video.mp4">', skip: Env.browser.isFirefox() },
    // TINY-7871: Safari 14.1 also appears to have a bug that causes it to freeze without a valid object
    { type: 'object', content: '<object data="custom/sseeditor/file.pdf"></object>', skip: Env.browser.isFirefox() || Env.browser.isSafari() }
  ], (test) => {
