...
import { UploadResult } from 'sseeditor/core/api/EditorUpload';
import Env from 'sseeditor/core/api/Env';
import { BlobInfo } from 'sseeditor/core/api/file/BlobCache';
...
describe('browser.sseeditor.core.EditorUploadTest', () => {
