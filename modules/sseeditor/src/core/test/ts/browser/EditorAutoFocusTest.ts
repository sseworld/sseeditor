...
describe.skip('browser.sseeditor.core.EditorAutoFocusTest', () => {
  before(() => {
    Insert.append(SugarBody.body(), SugarElement.fromHtml(`<div id="abc">
      <div class="sseeditor" id="mce_0">Editor_0</div>
      <div style="margin-top: ${window.innerHeight}px"><div class="sseeditor" id="mce_1">Editor_1</div></div>
      <div style="margin-top: ${window.innerHeight}px"><div class="sseeditor" id="mce_2">Editor_2</div></div>
    </div>`));
  });
