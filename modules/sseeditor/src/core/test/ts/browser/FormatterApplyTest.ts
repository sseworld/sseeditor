...
describe('browser.sseeditor.core.FormatterApplyTest', () => {
  ...
  it('Bug #5134 - SSEEditor removes formatting tags in the getContent', () => {
    const editor = hook.editor();
    editor.setContent('');
    editor.formatter.register('format', {
      inline: 'strong',
    ...
    editor.formatter.apply('format');
    assert.equal(getContent(editor), '', 'empty SSEEditor');
    editor.selection.setContent('a');
    assert.equal(getContent(editor), '<p><strong>a</strong></p>', 'bold text inside SSEEditor');
  });

  it('Bug #5134 - SSEEditor removes formatting tags in the getContent - typing', () => {
    const editor = hook.editor();
    editor.setContent('');
    editor.formatter.register('format', {
      inline: 'strong',
