...
describe('browser.sseeditor.core.FormattingCommandsTest', () => {
  ...
  context('Formatting commands (alignInline)', () => {
    ...
    it('TBA - img, JustifyLeft', () => {
      const editor = hook.editor();
      editor.setContent('<img src="sseeditor/ui/img/raster.gif" />');
      editor.selection.select(editor.dom.select('img')[0]);
      editor.execCommand('JustifyLeft');
      TinyAssertions.assertContent(editor, '<p><img style="float: left;" src="sseeditor/ui/img/raster.gif"></p>');
    });
    ...
    it('TBA - img, JustifyCenter', () => {
      ...
      TinyAssertions.assertContent(
        editor,
        '<p><img style="margin-right: auto; margin-left: auto; display: block;" src="sseeditor/ui/img/raster.gif"></p>'
      );
    });
    ...
    it('TBA - img, JustifyRight', () => {
      ...
      editor.selection.select(editor.dom.select('img')[0]);
      editor.execCommand('JustifyRight');
      TinyAssertions.assertContent(editor, '<p><img style="float: right;" src="sseeditor/ui/img/raster.gif"></p>');
    });
  });
