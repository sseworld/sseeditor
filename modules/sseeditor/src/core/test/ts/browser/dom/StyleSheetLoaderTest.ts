...
describe('browser.sseeditor.core.dom.StyleSheetLoaderTest', () => {
  const contentCss = '/project/sseeditor/js/sseeditor/skins/content/default/content.css';
  const skinCss = '/project/sseeditor/js/sseeditor/skins/ui/oxide/skin.css';
