...
describe('browser.sseeditor.core.dom.ContentCssCorsTest', () => {
  const settings = {
  ...
  context('Classic mode: Editor StyleSheetLoader is separate from global (sseeditor)', () => {
  ...
  context('Inline mode: Global (sseeditor) StyleSheetLoader is shared amongst multiple inline editors', () => {
  ...
  context('Classic and inline editors: Global (sseeditor) StyleSheetLoader is shared amongst multiple inline editors, but classic editor has separate stylesheetloader', () => {
