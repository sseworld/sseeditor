...
import { GetContentEvent, SetContentEvent } from 'sseeditor/core/api/EventTypes';
import { EditorEvent } from 'sseeditor/core/api/util/EventDispatcher';
import { Bookmark } from 'sseeditor/core/bookmark/BookmarkTypes';
import * as CaretContainer from 'sseeditor/core/caret/CaretContainer';
import * as Zwsp from 'sseeditor/core/text/Zwsp';

describe('browser.sseeditor.core.dom.SelectionTest', () => {
