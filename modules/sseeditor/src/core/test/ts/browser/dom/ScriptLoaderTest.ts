...
import ScriptLoader from 'sseeditor/core/api/dom/ScriptLoader';

describe('browser.sseeditor.core.dom.ScriptLoaderTest', () => {
  const testScript = '/project/sseeditor/src/core/test/assets/js/test.js';
  const nestedScript = '/project/sseeditor/src/core/test/assets/js/nested.js';
  const invalidScript = '/project/sseeditor/src/core/test/assets/js/invalid.js';
  let loadedCount = 0;

  before(() => {
    Global.sseeditor_ = { ScriptLoader: ScriptLoader.ScriptLoader };
  });

  after(() => {
    delete Global.sseeditor_;
  });
