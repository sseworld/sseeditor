...
describe('browser.sseeditor.core.dom.DOMUtilsTest', () => {
  ...
  it('loadCSS', () => {
    ...
    DOM.loadCSS('sseeditor/dom/test.css?a=1,sseeditor/dom/test.css?a=2,sseeditor/dom/test.css?a=3');
  ...
  it('loadCSS contentCssCors enabled', () => {
    ...
    CustomDOM.loadCSS('sseeditor/dom/test_cors.css?a=1,sseeditor/dom/test_cors.css?a=2,sseeditor/dom/test_cors.css?a=3');
  ...
  it('isEmpty', () => {
    ...
    DOM.setHTML('test', '<img src="sseeditor/ui/img/raster.gif">');
    assert.isFalse(DOM.isEmpty(getTestElement()));
