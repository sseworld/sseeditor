...
import { BeforeOpenNotificationEvent, OpenNotificationEvent } from 'sseeditor/core/api/EventTypes';
import { NotificationSpec } from 'sseeditor/core/api/NotificationManager';

describe('browser.sseeditor.core.NotificationManagerTest', () => {
  Arr.each([
