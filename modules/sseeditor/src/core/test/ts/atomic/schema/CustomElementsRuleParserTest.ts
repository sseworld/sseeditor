...
import * as CustomElementsRuleParser from 'sseeditor/core/schema/CustomElementsRuleParser';

describe('atomic.sseeditor.core.schema.CustomElementsRuleParserTest', () => {
