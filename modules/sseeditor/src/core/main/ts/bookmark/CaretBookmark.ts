 ...
 * @private
 * @static
 * @class sseeditor.caret.CaretBookmark
 * @example
...
export {
   ...
   * @param {sseeditor.caret.CaretPosition} caretPosition Caret position within the root node.
   ...
   * @return {sseeditor.caret.CaretPosition} Caret position resolved from xpath like bookmark.
   */
  resolve
};
