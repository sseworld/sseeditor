...
const logRemovedWarnings = (rawOptions: RawEditorOptions, normalizedOptions: NormalizedEditorOptions): void => {
  ...
  if (hasRemovedPlugins || hasRemovedOptions || isLegacyMobileTheme) {
    ...
    console.warn(
      'The following deprecated features are currently enabled and have been removed in SSEEditor 7.0. These features will no longer work and should be removed from the SSEEditor configuration. ' +
      'See https://www.tiny.cloud/docs/sseeditor/7/migration-from-6x/ for more information.' +
      themesMessage +
      pluginsMessage +
      optionsMessage
    );
