...
const Quirks = (editor: Editor): Quirks => {
   ...
   * left there. SSEEditor sees a floating text node and wraps it in a paragraph on the key up event (ForceBlocks.js
  ...
  /**
   * WebKit will produce DIV elements here and there by default. But since SSEEditor uses paragraphs by
