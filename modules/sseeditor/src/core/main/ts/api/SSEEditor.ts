...
interface SSEEditor extends EditorManager {
...
/**
 * @include ../../../../../tools/docs/sseeditor.js
 */

/**
 * @include ../../../../../tools/docs/sseeditor.Event.js
 */

/**
 * @include ../../../../../tools/docs/sseeditor.editor.ui.Ui.js
 */
...
const sseeditor: SSEEditor = Tools.extend(EditorManager, publicApi);
