...
/**
 * This mixin contains the event logic for the sseeditor.Editor class.
 *
 * @mixin sseeditor.EditorObservable
 * @extends sseeditor.util.Observable
 * @private
 */
 ...
 *
 * @private
 * @param {sseeditor.Editor} editor Editor instance to get event target from.
