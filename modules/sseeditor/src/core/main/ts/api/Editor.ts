...
/**
 * This class contains the core logic for a SSEEditor editor.
 *
 * @class sseeditor.Editor
 * @mixes sseeditor.util.Observable
 * @example
 * // Add a class to all paragraphs in the editor.
 * sseeditor.activeEditor.dom.addClass(sseeditor.activeEditor.dom.select('p'), 'someclass');
 *
 * // Gets the current editors selection as text
 * sseeditor.activeEditor.selection.getContent({ format: 'text' });
 *
 * // Creates a new editor instance
 * const ed = new sseeditor.Editor('textareaid', {
 *   some_setting: 1
 * }, sseeditor.EditorManager);
 *
 * ed.render();
 */
 ...
 *
 * @include ../../../../../tools/docs/sseeditor.Editor.js
 */
...
class Editor implements EditorObservable {
   ...
   * sseeditor.activeEditor.plugins.someplugin.someMethod();
   */
  public plugins: Record<string, Plugin> = {};

  /**
   * URI object to document configured for the SSEEditor instance.
   *
   * @property documentBaseURI
   * @type sseeditor.util.URI
   * @example
   * // Get relative URL from the location of document_base_url
   * sseeditor.activeEditor.documentBaseURI.toRelative('/somedir/somefile.htm');
   *
   * // Get absolute URL from the location of document_base_url
   * sseeditor.activeEditor.documentBaseURI.toAbsolute('somefile.htm');
   */
  public documentBaseURI: URI;

  /**
   * URI object to current document that holds the SSEEditor editor instance.
   *
   * @property baseURI
   * @type sseeditor.util.URI
   * @example
   * // Get relative URL from the location of the API
   * sseeditor.activeEditor.baseURI.toRelative('/somedir/somefile.htm');
   *
   * // Get absolute URL from the location of the API
   * sseeditor.activeEditor.baseURI.toAbsolute('somefile.htm');
   */
  public baseURI: URI;
   ...
   * @param {sseeditor.EditorManager} editorManager EditorManager instance.
   */
  ...
  /**
   * Focuses/activates the editor. This will set this editor as the activeEditor in the sseeditor collection
   ...
   * <br>
   * <em>Deprecated in SSEEditor 6.0 and has been marked for removal in SSEEditor 7.0. Use the <code>editor.options.get</code> API instead.</em>
   *
   * @method getParam
   ...
   * const someval = sseeditor.activeEditor.getParam('myvalue');
   *
   * // Returns a specific config value from a specific editor instance by id
   * const someval2 = sseeditor.get('my_editor').getParam('myvalue');
   */
   ...
   *
   * @method hasPlugin
   * @param {String} name The name of the plugin, as specified for the SSEEditor `plugins` option.
   ...
   * the sseeditor command identifiers documentation.
   *
   * @method execCommand
   ...
   * sseeditor.activeEditor.setProgressState(true);
   *
   * // Hide progress for the active editor
   * sseeditor.activeEditor.setProgressState(false);
   *
   * // Show progress after 3 seconds
   * sseeditor.activeEditor.setProgressState(true, 3000);
   */
   ...
   * <br>
   * <em>Note: The content return value was deprecated in SSEEditor 6.0 and has been marked for removal in SSEEditor 7.0.</em>
   *
   * @method setContent
   ...
   * sseeditor.activeEditor.setContent('<span>some</span> html');
   *
   * // Sets the content of a specific editor (my_editor in this example)
   * sseeditor.get('my_editor').setContent(data);
   *
   * // Sets the content of the activeEditor editor using the specified format
   * sseeditor.activeEditor.setContent('<p>Some html</p>', { format: 'html' });
   */
   ...
   * console.debug(sseeditor.activeEditor.getContent());
   *
   * // Get the contents of the currently active editor as plain text
   * sseeditor.activeEditor.getContent({ format: 'text' });
   *
   * // Get content of a specific editor:
   * sseeditor.get('content id').getContent()
   */
   ...
   * @example
   * if (sseeditor.activeEditor.isDirty()) {
   ...
   * @example
   * const ajaxSave = () => {
   *   const editor = sseeditor.get('elm1');
   *
  ...
  /**
   * Returns the target element/textarea that got replaced with a SSEEditor editor instance.
   *
   * @method getElement
  ...
  /**
   * Removes the editor from the dom and sseeditor collection.
   *
   * @method remove
   */
  public remove(): void {
