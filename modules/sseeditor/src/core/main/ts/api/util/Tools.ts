 ...
 * directly on the sseeditor namespace.
 *
 * @class sseeditor.util.Tools
 */
 ...
 * const obj = sseeditor.resolve('a.b.c.d');
 */
 ...
 * const arr = sseeditor.explode('a, b,   c');
 */
...
const Tools: Tools = {
   ...
   * @example
   * // Iterate an array
   * sseeditor.each([ 1,2,3 ], (v, i) => {
   *   console.debug("Value: " + v + ", Index: " + i);
   * });
   *
   * // Iterate an object
   * sseeditor.each({ a: 1, b: 2, c: 3 }, (v, k) => {
   ...
   * const items = sseeditor.grep([ 1,2,3,4,5 ], (v) => v > 3);
   */
