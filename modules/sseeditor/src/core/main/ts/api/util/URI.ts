...
class URI {
   ...
   * const url = new sseeditor.util.URI('http://www.site.com/dir/').toRelative('http://www.site.com/dir/somedir/somefile.htm');
   */
   ...
   * const url = new sseeditor.util.URI('http://www.site.com/dir/').toAbsolute('somedir/somefile.htm');
   */
   ...
   *
   * @method isSameOrigin
   * @param {sseeditor.util.URI} uri Uri instance to compare.
