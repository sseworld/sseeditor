...
/**
 * This class handles the creation of SSEEditor's notifications.
 *
 * @class sseeditor.NotificationManager
 * @example
...
const NotificationManager = (editor: Editor): NotificationManager => {
  ...
  return {
     ...
     * <br /><br />
     * For information on the available settings, see: <a href="https://www.tiny.cloud/docs/sseeditor/6/creating-custom-notifications/">Create custom notifications</a>.
     */
    open,
