...
/**
 * SSEEditor theme pseudo class. Allows for a custom theme to be used with SSEEditor when registered using the ThemeManager.
 *
 * @summary This is a pseudo class that describes how to create a custom theme for SSEEditor.
 * <br><br>
 * See AddOnManager for more information about the methods available on the ThemeManager instance.
 * <br><br>
 * <strong>Warning</strong>: Much of SSEEditor's functionality is provided by the default Silver theme.
 * Creating a custom theme may require the re-implementation of this functionality.
 * To change SSEEditor's appearance, Tiny recommends changing the Skin instead.
 *
 * @class sseeditor.Theme
 * @example
 * sseeditor.ThemeManager.add('MyTheme', (editor) => {
...
/**
 * SSEEditor plugin psuedo class. Allows for custom plugins to be added to SSEEditor when registered using the PluginManager.
 *
 * @summary This is a pseudo class that describes how to create a custom plugin for SSEEditor.
 * <br><br>
 ...
 *
 * @class sseeditor.Plugin
 * @example
 * sseeditor.PluginManager.add('MyPlugin', (editor, url) => {
...
const AddOnManager = <T>(): AddOnManager<T> => {
  ...
  return {
     ...
     * @return {sseeditor.Theme/sseeditor.Plugin} Theme or plugin add-on instance or undefined.
     */
    get,
     ...
     * @param {sseeditor.Theme/sseeditor.Plugin} addOn Theme or plugin to add.
     * @return {sseeditor.Theme/sseeditor.Plugin} The same theme or plugin instance that got passed in.
     * @example
     ...
     * sseeditor.PluginManager.add('test', TestPlugin);
     *
     * // Initialize SSEEditor
     * sseeditor.init({
     *   ...
     ...
     * sseeditor.PluginManager.load('myplugin', '/some/dir/someplugin/plugin.js');
     *
     * // Initialize SSEEditor
     * sseeditor.init({
     *   ...
