 ...
 *
 * @class sseeditor.dom.DOMUtils
 * @example
 * // Add a class to an element by id in the page
 * sseeditor.DOM.addClass('someid', 'someclass');
 *
 * // Add a class to an element by id inside the editor
 * sseeditor.activeEditor.dom.addClass('someid', 'someclass');
 */
...
/**
 * Constructs a new DOMUtils instance. Consult the SSEEditor Documentation for more details on settings etc for this class.
 *
 * @private
 * @constructor
 * @method DOMUtils
...
const DOMUtils = (doc: Document, settings: Partial<DOMUtilsSettings> = {}): DOMUtils => {
  ...
  const self: DOMUtils = {
     ...
     * sseeditor.activeEditor.dom.addClass(sseeditor.activeEditor.dom.select('span.test'), 'someclass')
     */
    select,
     ...
     * sseeditor.activeEditor.dom.add(sseeditor.activeEditor.getBody(), 'p', { title: 'my title' }, 'Some content');
     */
    add,
     ...
     * var el = sseeditor.activeEditor.dom.create('div', { id: 'test', 'class': 'myclass' }, 'some content');
     * sseeditor.activeEditor.selection.setNode(el);
     */
    create,
     ...
     * sseeditor.activeEditor.selection.setContent(sseeditor.activeEditor.dom.createHTML('a', { href: 'test.html' }, 'some line'));
     */
    createHTML,
     ...
     * sseeditor.activeEditor.dom.remove(sseeditor.activeEditor.dom.select('p'));
     *
     * // Removes an element by id in the document
     * sseeditor.DOM.remove('mydiv');
     */
    remove,
     ...
     * sseeditor.activeEditor.dom.setStyle(sseeditor.activeEditor.dom.select('p'), 'background-color', 'red');
     *
     * // Sets a style value to an element by id in the current document
     * sseeditor.DOM.setStyle('mydiv', 'background-color', 'red');
     */
    setStyle,
     ...
     * sseeditor.activeEditor.dom.setStyles(sseeditor.activeEditor.dom.select('p'), { 'background-color': 'red', 'color': 'green' });
     *
     * // Sets styles to an element by id in the current document
     * sseeditor.DOM.setStyles('mydiv', { 'background-color': 'red', 'color': 'green' });
     */
    setStyles,
     ...
     * sseeditor.activeEditor.dom.setAttrib(sseeditor.activeEditor.dom.select('p'), 'class', 'myclass');
     *
     * // Sets class attribute on a specific element in the current page
     * sseeditor.dom.setAttrib('mydiv', 'class', 'myclass');
     */
    setAttrib,
     ...
     * sseeditor.activeEditor.dom.setAttribs(sseeditor.activeEditor.dom.select('p'), { 'class': 'myclass', title: 'some title' });
     *
     * // Sets class and title attributes on a specific element in the current page
     * sseeditor.DOM.setAttribs('mydiv', { 'class': 'myclass', title: 'some title' });
     */
    setAttribs,
     ...
     * sseeditor.DOM.loadCSS('somepath/some.css');
     *
     * // Loads a CSS file into the currently active editor instance
     * sseeditor.activeEditor.dom.loadCSS('somepath/some.css');
     *
     * // Loads a CSS file into an editor instance by id
     * sseeditor.get('someid').dom.loadCSS('somepath/some.css');
     *
     * // Loads multiple CSS files into the current document
     * sseeditor.DOM.loadCSS('somepath/some.css,somepath/someother.css');
     */
    loadCSS,
     ...
     * sseeditor.activeEditor.dom.addClass(sseeditor.activeEditor.dom.select('p'), 'myclass');
     *
     * // Adds a class to a specific element in the current page
     * sseeditor.DOM.addClass('mydiv', 'myclass');
     */
    addClass,
     ...
     * sseeditor.activeEditor.dom.removeClass(sseeditor.activeEditor.dom.select('p'), 'myclass');
     *
     * // Removes a class from a specific element in the current page
     * sseeditor.DOM.removeClass('mydiv', 'myclass');
     */
    removeClass,
     ...
     * sseeditor.activeEditor.dom.setHTML(sseeditor.activeEditor.dom.select('p'), 'some inner html');
     *
     * // Sets the inner HTML of an element by id in the document
     * sseeditor.DOM.setHTML('mydiv', 'some inner html');
     */
    setHTML,
     ...
     * @example
     * sseeditor.DOM.getOuterHTML(editorElement);
     * sseeditor.activeEditor.getOuterHTML(sseeditor.activeEditor.getBody());
     */
    getOuterHTML,
     ...
     * sseeditor.activeEditor.dom.setOuterHTML(sseeditor.activeEditor.dom.select('p'), '<div>some html</div>');
     *
     * // Sets the outer HTML of an element by id in the document
     * sseeditor.DOM.setOuterHTML('mydiv', '<div>some html</div>');
     */
    setOuterHTML,
     ...
     * @example
     * sseeditor.DOM.isEmpty(node, { img: true });
     */
    isEmpty,

    /**
     * Creates a new DOM Range object. This will use the native DOM Range API if it's
     * available. If it's not, it will fall back to the custom SSEEditor implementation.
     *
     * @method createRng
     * @return {DOMRange} DOM Range object.
     * @example
     * const rng = sseeditor.DOM.createRng();
     ...
     * <br>
     * <em>Deprecated in SSEEditor 6.0 and has been marked for removal in SSEEditor 7.0. Use <code>dispatch</code> instead.</em>
     *
     * @method fire
