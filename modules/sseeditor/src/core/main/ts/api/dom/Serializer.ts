...
/**
 * This class is used to serialize DOM trees into a string. Consult the SSEEditor API Documentation for
 * more details and examples on how to use this class.
 *
 * @class sseeditor.dom.Serializer
 */
...
const DomSerializer = (settings: DomSerializerSettings, editor?: Editor): DomSerializer => {
  ...
  return {
     ...
     *
     * @field {sseeditor.html.Schema} schema
     */
     ...
     * Consult the SSEEditor Documentation for more details on this format.
     *
     * @method addRules
