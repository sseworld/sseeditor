 ...
 *
 * @class sseeditor.html.Schema
 * @version 3.4
 * @example
 * if (sseeditor.activeEditor.schema.isValidChild('p', 'span')) {
 *   alert('span is valid child of p.');
 * }
 *
 * if (sseeditor.activeEditor.schema.getElementRule('p')) {
...
const Schema = (settings: SchemaSettings = {}): Schema => {
   ...
   * <a href="https://www.tiny.cloud/docs/sseeditor/latest/content-filtering/#custom_elements">custom_elements</a>
   *
