 ...
 *
 * @class sseeditor.html.Serializer
 * @version 3.4
 * @example
 * sseeditor.html.Serializer().serialize(sseeditor.html.DomParser().parse('<p>text</p>'));
 */
...
const HtmlSerializer = (settings: HtmlSerializerSettings = {}, schema: Schema = Schema()): HtmlSerializer => {
   ...
   *
   * @method serialize
   * @param {sseeditor.html.Node} node Node instance to serialize.
