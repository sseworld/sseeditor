...
/**
 * SSEEditor Editor Upload API
 * Handles image uploads, updates undo stack and patches over various internal functions.
 *
 * @class sseeditor.EditorUpload
 * @example
 * // Apply a new filter within the image scan.
 * sseeditor.activeEditor.EditorUpload.addFilter((image) => {
 ...
 * sseeditor.activeEditor.EditorUpload.uploadImages();
 *
 * // Scan the editor for valid images
 * sseeditor.activeEditor.EditorUpload.scanForImages();
 */
