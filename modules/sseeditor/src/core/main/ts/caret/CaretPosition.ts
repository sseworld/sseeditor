 ...
 *
 * @private
 * @class sseeditor.caret.CaretPosition
 * @example
...
export const CaretPosition = (container: Node, offset: number, clientRects?: GeomClientRect[]): CaretPosition => {
  ...
  return {
     ...
     *
     * @method isEqual
     * @param {sseeditor.caret.CaretPosition} caretPosition Caret position to compare with.
 ...
 * @return {sseeditor.caret.CaretPosition} Caret position from the start of DOM range.
 */
 ...
 * @method fromRangeEnd
 * @param {DOMRange} range DOM Range to create caret position from.
 * @return {sseeditor.caret.CaretPosition} Caret position from the end of DOM range.
 */
 ...
 * @return {sseeditor.caret.CaretPosition} Caret position from the node.
 */
