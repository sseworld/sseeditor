 ...
 *
 * @private
 * @class sseeditor.caret.CaretWalker
 * @example
...
export const CaretWalker = (root: Node): CaretWalker => ({
  /**
     ...
     *
     * @method next
     * @param {sseeditor.caret.CaretPosition} caretPosition Caret position to start from.
     * @return {sseeditor.caret.CaretPosition} CaretPosition or null if no position was found.
     */
  next: (caretPosition: CaretPosition | null): CaretPosition | null => {
