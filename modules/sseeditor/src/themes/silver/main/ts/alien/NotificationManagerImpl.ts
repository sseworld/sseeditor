...
import { NotificationApi, NotificationManagerImpl, NotificationSpec } from 'sseeditor/core/api/NotificationManager';
import Delay from 'sseeditor/core/api/util/Delay';
...
export default (editor: Editor, extras: Extras, uiMothership: Gui.GuiSystem): NotificationManagerImpl => {
  ...
  const getBounds = () => {
     ...
     *
     * Note: This isn't perfect, but we have a plan to fix it now that SSEEditor 6 removed public methods restricting
