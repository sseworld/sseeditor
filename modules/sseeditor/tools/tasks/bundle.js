...
module.exports = function (grunt) {
  grunt.registerMultiTask(
    "bundle",
    "Bundles code, themes and bundles to a single file.",
    function () {
      ...
      if (!themes && !plugins) {
        grunt.log.writeln(
          "Use: grunt bundle --themes <comma separated list of themes> --plugins <comma separated list of plugins> --icons <comma separated list of icons> --models <comma separated list of models>"
        );
        process.exit(-1);
        return;
      }
