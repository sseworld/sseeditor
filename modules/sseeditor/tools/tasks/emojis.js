...
const generateContent = (json, attribution) => {
  const content = `window.sseeditor.Resource.add('sseeditor.plugins.emoticons', ${json});`;
...
module.exports = function (grunt) {
  grunt.registerTask(
    "emojis",
    "Generates the emoji databases used for the emoticon plugin",
    function () {
      ...
      Object.keys(emojiDatabase).forEach((name) => {
        ...
        item.char = twemoji
          .parse(item.char, twemojiOptions)
          .replace(
            'class="emoji"',
            'data-emoticon="true" style="width:1em;height:1em;margin:0 .05em 0 .1em;vertical-align:-.1em"'
          )
      ...
      grunt.file.write(
        "src/plugins/emoticons/main/js/emojis.js",
        generateContent(emojiJson, ", file:emojis.json")
      );
      grunt.file.write(
        "src/plugins/emoticons/main/js/emojiimages.js",
        generateContent(
          prettyPrint(emojiImageDatabase),
