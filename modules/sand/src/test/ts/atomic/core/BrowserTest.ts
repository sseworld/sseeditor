...
import { UserAgentData, UserAgentDataBrand } from "ssephox/sand/detect/UaData";
...
describe("BrowserTest", () => {
  ...
  it("Firefox", () => {
    ...
    check(
      ...
      6,
      "Mozilla/5.0 (Windows; U; Windows NT 6.1; en-GB; rv:1.9.2) Gecko/20100115 Firefox/3.6",
      mockUserAgentData([{ brand: "Firefox", version: "10" }])
    );
  });
  ...
  it("Chrome", () => {
    ...
    check(
      ...
      0,
      "Mozilla/5.0 (Windows; U; Windows NT 6.0; en-US) AppleWebKit/534.3 (KHTML, like Gecko) Chrome/6.0.472.53 Safari/534.3",
      mockUserAgentData([{ brand: "Chromium", version: "10" }])
    );
  });
  ...
  it("Chromium Edge", () => {
    ...
    check(
      ...
      0,
      "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/92.0.4515.131 Safari/537.36 Edg/92.0.902.73",
      mockUserAgentData([{ brand: "Chromium", version: "93" }])
    );
  });
